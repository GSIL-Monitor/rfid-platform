...
<body class="no-skin">
								...
								<div class="widget-main" id="searchPanel" style="display: none">
									<form class="form-horizontal" role="form" id="searchForm">
												...
												<div class="input-group">
													...
													<span class="input-group-btn">
														<button class="btn btn-sm btn-default" type="button"
															onclick="open_multi_warehouseDialog('#search_destId',callback)">
										...
										<div class="form-group">
											...
											<label
												class="col-xs-4 col-sm-4 col-md-1 col-lg-1 text-right control-label"
												for="search_origUnitId">发货方</label>

											<div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
												<div class="input-group">
													<input class="form-control" id="search_origUnitId"
														name="filter_INS_origUnitId" type="text"
														placeholder="编号列表" /> <span class="input-group-btn">
														<button class="btn btn-sm btn-default" type="button"
															onclick="openUnitDialog('#search_origUnitId','',callback)">
															<i class="ace-icon fa fa-list"></i>
														</button>
													</span>
												</div>
											...
											<div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
												...
												<div class="input-group">
													...
													<span class="input-group-btn">
														<button class="btn btn-sm btn-default" type="button"
															onclick="_openUnitDialog('#search_origId','')">
															<i class="ace-icon fa fa-list"></i>
														</button>
													</span>
												</div>
											...
											<label
												class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right"
												for="search_beginTime">创建日期 </label>

											<div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
												<div class="input-group">
													<input class="form-control date-picker"
														id="search_beginTime" type="text"
														name="filter_GED_beginTime" data-date-format="yyyy-mm-dd" />
	...
	<jsp:include page="../layout/footer_js.jsp"></jsp:include>
		...
		<jsp:include page="../base/warehouse_multi_dialog.jsp"></jsp:include>
			<script type="text/javascript"
		src="<%=basePath%>/views/task/inboundController.js"></script>
	<script type="text/javascript">
		function callback(){}
	</script>
</body>
