                                ...
                                <form class="form-horizontal" role="form" id="searchForm">
                                    <div class="form-group">
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label"
                                               for="form_deviceId">设备号</label>
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="chosen-select  form-control" id="form_deviceId"
                                                   name="filter_CONTAINS_deviceId"/>
                                        </div>

                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label"
                                               for="form_warehouseCode">仓储</label>

                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <select class="form-control" id="form_warehouseCode"
                                                    name="filter_in_warehouseCode" multiple="multiple" ></select>
                                        </div>
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label"
                                               for="form_factoryCode">工厂</label>

                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <select class="form-control" id="form_factoryCode"
                                                   name="filter_in_factoryCode" multiple="multiple" >
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<script type="text/javascript" src="<%=basePath%>/views/cclean/deviceController.js"></script>
