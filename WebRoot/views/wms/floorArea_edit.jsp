...
<div class="main-container" id="main-container">
    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div id="page-content">
                <div class="col-lg-12">
                    <form class="form-horizontal" role="form" id="floorareaEditForm" style="margin-top: 18px">
...
<script>
            ...
            success: function (result) {
                ...
                for(var i=0;i<json.length;i++){
                    ...
                    if ("${floorarea.id}" != "") {
                        ...
                        initFloorareaFormValid(false,"${floorarea.barcode}","${shopId}");
                    }
                    if ("${parentId}" != "") {
    ...
    function initFloorareaFormValid(isAdd, oldBarcode) {
        $('#floorareaEditForm').bootstrapValidator({
            message: '输入值无效',
            feedbackIcons: {
                ...
                barcode: {
                    validators: {
                        ...
                        remote: {//ajax验证。server result:{"valid",true or false} 向服务发送当前input name值，获得一个json数据。例表示正确：{"valid",true}
                            url: basePath + "/wms/pl/checkBarcode.do?flag=fa&isAdd=" + isAdd + "&oldBarcode=" + oldBarcode,//验证地址
                            message: '条码已存在',//提示消息
...
function save(){
    $('#floorareaEditForm').data('bootstrapValidator').validate();
    if(!$('#floorareaEditForm').data('bootstrapValidator').isValid()){
        return ;
    }
    saveImg($("#form_barcode").val());
    var formData= $("#floorareaEditForm").serialize();

    $.ajax({
        type: "POST",
        url: basePath + "/wms/pl/saveFa.do",
        data: formData,
        dataType: "json",
        success: function (result) {
   ...
   // 删除图片
    ...
    function saveImg(barcode){
        ...
        xhr.open("POST", basePath + "/wms/pl/saveImg.do?barcode="+barcode+"&flag=fa",false);
        xhr.send(fd);
    }
</script>
