                        ...
                        <div class="widget-body ">
                            ...
                            <div class="widget-toolbox padding-8 clearfix">
                                <div class="btn-toolbar" role="toolbar">
                                    ...
                                    <div class="btn-group btn-group-sm pull-left">
                                        <%--<button type="button" class="btn btn-primary" onclick="addFloorArea()">--%>
                                            <%--<i class="ace-icon fa fa-plus"></i>--%>
                                            <%--<span class="bigger-110">新增区</span>--%>
                                        <%--</button>--%>
                                ...
                                <form class="form-horizontal" role="form" id="searchForm">
                                    <div class="form-group">
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label"
                                               for="filter_IN_faParentCode">仓店</label>
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                        <select id="filter_IN_faParentCode" name="filter_IN_faParentCode"
                                                multiple="multiple" data-placeholder="仓店列表">
                                        </select>
                                        </div>

                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label"
                                               for="filter_CONTAINS_faBarcode">区</label>
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="form-control" id="filter_CONTAINS_faBarcode"
                                                   name="filter_CONTAINS_faBarcode" type="text"
                                                   placeholder="模糊查询"/>
                                        </div>

                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label"
                                               for="filter_CONTAINS_flBarcode">库位</label>
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="form-control" id="filter_CONTAINS_flBarcode"
                                                   name="filter_CONTAINS_flBarcode" type="text"
                                                   placeholder="模糊查询"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label"
                                               for="filter_CONTAINS_raBarcode">货架</label>
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="form-control" id="filter_CONTAINS_raBarcode"
                                                   name="filter_CONTAINS_raBarcode" type="text"
                                                   placeholder="模糊查询"/>
                                        </div>
...
<script type="text/javascript" src="<%=basePath%>/views/wms/wmsFloorController.js"></script>
</body>
</html>