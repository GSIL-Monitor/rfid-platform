                            ...
                            <div class="widget-main" id="searchPanel">
                                <form class="form-horizontal" role="form" id="editForm">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <select class="chosen-select  form-control" id="form_floorId" name="floorId" onchange="selectFloorId()">
                                            </select>
                                        </div>
...
<script type="text/javascript" src="<%=basePath%>/views/wms/wmsPlRackBindingRelationController.js"></script>
</body>
</html>