                            ...
                            <div class="widget-main" id="searchPanel" style="display:none;">
                                <form class="form-horizontal" role="form" id="searchForm">
                                    <div class="form-group">
                                        ...
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label"
                                               for="filter_CONTAINS_rackBarcode">货架</label>
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="form-control" id="filter_CONTAINS_rackBarcode"
                                                   name="filter_CONTAINS_rackBarcode" type="text"
                                                   placeholder="模糊查询"/>
                                        </div>
                                    </div>
...
<script type="text/javascript" src="<%=basePath%>/views/wms/pl/plWmsShopBindingRelationController.js"></script>
</body>
</html>