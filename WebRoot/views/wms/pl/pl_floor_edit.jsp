                ...
                <div class="col-lg-12">
                    <form class="form-horizontal" role="form" id="floorEditForm" style="margin-top: 18px">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-2 ">
                                <input id="form_parentName" class="form-control" type="text"
                                       readonly/>
                            </div>
                        </div>
                        <div class="form-group">
...
<script>
    $(function () {
        if ("${floor.id}" != "") {
            ...
            $("#form_parentName").val("${floor.parentName}");
        ...
        if ("${parentId}" != "") {
            ...
            $("#form_parentName").val("${parentName}");
        }
...
//                        },
                        ...
                        remote: {//ajax验证。server result:{"valid",true or false} 向服务发送当前input name值，获得一个json数据。例表示正确：{"valid",true}
                            url: basePath + "/wms/pl/warehouse/checkFloorBarcode.do?id="+$("#form_id").val()+"&parentId="+$("#form_parentId").val(),//验证地址
                            message: '条码已存在',//提示消息
    ...
    function save(){
        ...
        $.ajax({
            type: "POST",
            url: basePath + "/wms/pl/warehouse/saveFl.do",
            data: formData,
            dataType: "json",
    ...
    function saveImg(barcode){
        ...
        xhr.open("POST", basePath + "/wms/pl/warehouse/saveImg.do?barcode="+barcode+"&flag=fl",false);
        xhr.send(fd);
    }
</script>
