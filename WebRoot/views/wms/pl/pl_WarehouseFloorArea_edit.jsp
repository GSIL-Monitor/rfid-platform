    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    <li><a href="#"
                           onclick="javascript: window.location.href=basePath+'/views/wms/pl/plWarehouseWms.jsp';">PL区管理</a></li>
                    <li class="active">
                    </li>
                </ul>
                <a href="#" onclick="javascript: window.location.href=basePath+'/views/wms/pl/plWarehouseWms.jsp';"
...
<script>
    $(function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if ("${parentCode}" != "") {
                    $("#form_parentCode").find("option[value='${parentCode}']").attr("selected",true);
    ...
    function inputBarcode(input){
       ...
       console.log( $('#form_parentCode option:selected') .val());
    }
...
//                        },
                        ...
                        remote: {//ajax验证。server result:{"valid",true or false} 向服务发送当前input name值，获得一个json数据。例表示正确：{"valid",true}
                            url: basePath + "/wms/pl/warehouse/checkWarehouseFloorAreaBarcode.do?id="+$("#form_id").val()+"&shopId="+$('#form_parentCode option:selected').val(),
                            message: '条码已存在',//提示消息
    ...
    function save(){
        ...
        $.ajax({
            type: "POST",
            url: basePath + "/wms/pl/warehouse/saveFa.do",
            data: formData,
            dataType: "json",
            success: function (result) {
    ...
    function deleteImg(image){
        $.ajax({
            url:basePath+"/wms/pl/warehouse/deleteImg.do?image="+image,
            type:'post',
            async:false,
            dataType : 'json',
            success:function(result){
    ...
    function saveImg(barcode){
        ...
        xhr.open("POST", basePath + "/wms/pl/warehouse/saveImg.do?barcode="+barcode+"&flag=fa",false);
        xhr.send(fd);
    }
</script>
