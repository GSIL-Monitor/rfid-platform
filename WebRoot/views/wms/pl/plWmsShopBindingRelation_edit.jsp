                            ...
                            <div class="widget-toolbox padding-8 clearfix">
                                <div class="btn-toolbar" role="toolbar">
                                    ...
                                    <div class="btn-group btn-group-sm pull-right">
                                        <button class="btn btn-info" onclick="javascript: window.location.href=basePath+'/views/wms/pl/plWmsShopBindingRelation.jsp'">
                            ...
                            <div class="widget-main" id="searchPanel">
                                <form class="form-horizontal" role="form" id="editForm">
                                    <div class="form-group">
                                        ...
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label"
                                               for="form_rackId">货架</label>

                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <select class="chosen-select  form-control" id="form_rackId" name="rackId">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<script type="text/javascript" src="<%=basePath%>/views/wms/pl/plWmsShopBindingRelation_edit.js"></script>
</body>
</html>