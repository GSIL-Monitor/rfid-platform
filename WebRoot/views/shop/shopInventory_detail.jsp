...
<body class="no-skin">
							...
							<div class="widget-main padding-12">
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<label class="col-xs-1 control-label" for="search_storageId">门店</label>
										<div class="col-xs-2">
											<input class="form-control" id="search_origId"
												name="filter_LIKES_origId" type="text" disabled
												value="[${business.origId}]${business.origName}" />
										</div>
	...
	<script type="text/javascript">
		...
		function initGrid() {
			...
			$("#detailgrid").jqGrid({
				height : 500,
				url : basePath + "/shop/shopInventory/detailPage.do?id=" + id,
				datatype : "json",
				colModel : [ {
					name : 'id',
					label : 'id',
		...
		function initRecordGrid() {
			...
			$("#recordgrid").jqGrid({
				height : 500,
				url : basePath + "/shop/shopInventory/recordPage.do?id=" + id,
				datatype : "json",
				colModel : [ {
					name : 'id',
					label : 'id',
