                            ...
                            <div class="widget-main" id="searchPanel" style="display:none">
                                <form class="form-horizontal" role="form" id="searchForm">
                                    <div class="form-group">
                                        ...
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right" for="search_token">入库方式</label>

                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <select class="chosen-select form-control" id="search_token"
                                                    name="filter_EQI_token" data-placeholder="">
                                                <option value="">--选择--</option>
                                                <option value="14">收货入库</option>
                                                <option value="17">销售退货</option>
                                                <option value="19">调拨入库</option>
                                            </select>
                                        </div>
                                    </div>
                                        <div class="form-group">
											<label
												...
												<div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
													<div class="input-group">
														<%-- <input class="form-control" id="form_code" name="ownerId" autocomplete="off"
														type="text" value="${User.ownerId}" /> --%>
														<input class="form-control" id="form_destId" value="${shopId}"type="text"
															name="filter_INS_destId" readonly /> <span class="input-group-btn">
															<button class="btn btn-sm btn-default" id="search_destId"
																type="button"
																onclick="openShopSelectDialog('#form_destId','#form_destName','')">
																<i class="ace-icon fa fa-list"></i>
															</button>
														</span> <input class="form-control" value="${shopName}" id="form_destName" type="text"
...
<script type="text/javascript" src="<%=basePath%>/views/shop/shopReceiveController.js"></script>
<script type="text/javascript">
