...
<body class="no-skin">
									...
									<div class="btn-toolbar" role="toolbar">
										...
										<div class="btn-group btn-group-sm pull-left">
											...
											<button class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
												<i class="ace-icon fa fa-plus"></i> <span class="bigger-110">增加</span><i class="ace-icon fa fa-chevron-down icon-on-right"></i>

											</button>

											<ul class="dropdown-menu dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
												<li>
													<a href="#"><i class="menu-icon fa fa-gift"></i> 单品促销</a>
												</li>

												<li>
													<a href="#"><i class="menu-icon fa fa-gift"></i> 套件促销</a>
												</li>

												<li>
													<a href="#"><i class="menu-icon fa fa-gift"></i>
														赠品促销</a>
												</li>
												...
												<li>
													<a href="#" onclick="_addMzcx()"><i class="menu-icon fa fa-gift"></i> 满赠促销</a>
												</li>
												<li>
													<a href="#" onclick="_addMjcx()"><i class="menu-icon fa fa-gift"></i> 满减促销</a>
												</li>
												<li>
													<a href="#"><i class="menu-icon fa fa-gift"></i> 满M件减N件促销</a>
												</li>
											</ul>
	...
	<script type="text/javascript"
		src="<%=basePath%>/views/shop/promotionController.js"></script>
</body>
</html>