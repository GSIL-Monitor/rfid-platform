                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <select class="chosen-select form-control" id="search_token"
                                                ...
                                                <option value="27">退仓出库</option>
                                                <option value="18">调拨出库</option>
                                                <option value="15">销售出库</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
										<label
												...
												<div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
													<div class="input-group">
														...
														<input class="form-control" id="form_origId" value="${shopId}" type="text"
															name="filter_INS_origId" readonly /> <span class="input-group-btn">
...
<script type="text/javascript" src="<%=basePath%>/views/shop/shopSendController.js"></script>
<script type="text/javascript">
