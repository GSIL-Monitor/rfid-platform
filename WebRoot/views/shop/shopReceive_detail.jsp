							...
							<div class="widget-main padding-12">
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-xs-2">
											<input class="form-control" id="search_deviceId"
												name="filter_LIKES_deviceId" type="text" disabled
												value='${business.deviceId}' />
										</div>

										<label class="col-xs-1 control-label" for="search_token">入库方式</label>
										<div class="col-xs-2">
											<input class="form-control" id="search_token"
												name="filter_LIKES_token" type="text" disabled
												value='<c:choose><c:when test="${business.token==14}">收货入库</c:when><c:when test="${business.token==17}">销售退货</c:when><c:when test="${business.token==19}">调拨入库</c:when></c:choose>'/> 
										</div>

										<label class="col-xs-1 control-label" for="search_totEpc">总数量</label>

										<div class="col-xs-2">
											<input class="form-control" id="search_totEpc"
												name="filter_LIKES_totEpc" type="text" disabled
												value='${business.totEpc}' />
										</div>
									...
									<div class="form-group">
										...
										<div class="col-xs-2">
											<input class="form-control" id="search_totStyle"
												name="filter_LIKES_totStyle" type="text" disabled
												value='${business.totStyle }' />
										</div>
										<label class="col-xs-1 control-label" for="search_totSku">SKU数</label>

										<div class="col-xs-2">
											<input class="form-control" id="search_totSku"
												name="filter_LIKES_totSku" type="text" disabled
												value='${business.totSku }' />
										</div>
										<label class="col-xs-1 control-label" for="search_origUnitId">发货方</label>

										<div class="col-xs-2">
											<input class="form-control" id="search_origUnitId"
												name="filter_LIKES_origUnitId" type="text" disabled
												value='[${business.origUnitId}]${business.origUnitName}' />
										</div>
										<label class="col-xs-1 control-label" for="search_beginTime">开始时间</label>

										<div class="col-xs-2">
											<input class="form-control" id="search_beginTime"
												name="filter_LIKES_beginTime" type="text" disabled
									...
									<div class="form-group">
										...
										<div class="col-xs-2">
											<input class="form-control" id="search_endTime"
												name="filter_LIKES_endTime" type="text" disabled
										...
										<div class="col-xs-2">
											<input class="form-control" id="search_billNo"
												name="filter_LIKES_billNo" type="text" disabled
												value='${business.billNo }' />
										</div>
										<label class="col-xs-1 control-label" for="search_id">任务号</label>

										<div class="col-xs-2">
											<input class="form-control" id="search_id"
												name="filter_LIKES_id" type="text" disabled
												value='${business.id }' />
										</div>
									</div>
								</form>
				...
				<div class="widget-header ">
					...
					<div class="widget-toolbar no-border">
						<ul class="nav nav-tabs" id="myTab">
							<li class="active"><a data-toggle="tab" href="#detail">SKU明细</a>
							</li>
							<li><a data-toggle="tab" href="#record">装箱明细</a></li>
						</ul>
					</div>
				</div>
				<div class="widget-body">
