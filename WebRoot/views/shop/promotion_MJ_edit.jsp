                    ...
                    <div class="col-xs-5">
                       ...
                       <div class="widget-box widget-color-blue  light-border">
                                        ...
                                        <form class="form-horizontal" role="form" id="editForm">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label no-padding-right"
                                                       for="form_type">满减类型</label>

                                                <div class="col-xs-9 col-sm-9">
                                                    <select class="chosen-select form-control" id="form_type" name="brandCode">
                                                        <option value="" style="background-color: #eeeeee" selected>阶梯满减</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
												...
												<span class="middle">满</span>
                                                    ...
                                                    <input class="input-mini" id="form_price2" name="price"
                                                           type="text" placeholder="" value=""/><span class="help-inline">
												<span class="middle"> 元
                                                    减</span>
											</span>
                                                    <input class="input-mini" id="form_price_3" name="price"
                                                           type="text" placeholder="" value=""/> 元&nbsp;&nbsp;
                                                    <div class="help-block col-xs-12 col-sm-reset inline">[<i class="ace-icon fa fa-remove red"></i>]
                                                       </div>
                                                </div>
                                            ...
                                            <div class="checkbox">
                                                <label class="col-sm-2 control-label no-padding-right"
                                                       for="form_all"></label>
                                                <label>
                                                    <input name="form-field-checkbox" id="form_all" class="ace ace-checkbox-2" type="checkbox" />
                                                ...
                                                <div class="checkbox">
                                                    <label class="col-sm-2 control-label no-padding-right"
                                                           for="form_hei"></label>
                                                    <label>
                                                        <input name="form-field-checkbox" id="form_hei" class="ace ace-checkbox-2" type="checkbox" />
                                                        <span class="lbl"> 黑名单</span>
                                                    </label>
                                                </div>
                                            </div>
                        ...
                        <div class="widget-body">
                            ...
                            <div class="widget-main">
                                    <div class="widget-box widget-color-blue  light-border"  id="zhuPingParent">
                                        <div class="widget-header">
                                            <h5 class="widget-title">设置黑名单</h5>
                                            <div class="widget-toolbar">
