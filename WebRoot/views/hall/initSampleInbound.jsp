            ...
            <div id="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                            ...
                            <div class="widget-main" id="searchPanel" style="display:none;">
                                <form class="form-horizontal" role="form" id="searchForm">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="form-control" name="filter_contains_code" id="filter_contains_code" placeholder="模糊查询"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right">入库方</label>
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                        ...
                        <div id="initGrid" style="height:700px"></div>
...
<script type="text/javascript" src="<%=basePath%>/views/hall/initSampleInboundController.js"></script>
</body>
</html>