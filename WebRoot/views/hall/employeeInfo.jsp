                        ...
                        <div class="widget-body">
                            <div class="widget-toolbox padding-8 clearfix">
                                <div class="btn-toolbar" role="toolbar">
                                    ...
                                    <div class="btn-group btn-group-sm pull-left">
                                        <button type="button" class="btn btn-primary" onclick="setUser()">
                                        <i class="ace-icon fa fa-star"></i>
                                        <span class="bigger-110">设置用户</span>
                                        </button>
                                    </div>
                            ...
                            <div class="widget-main" id="searchPanel" style="display:none">
                                <form class="form-horizontal" id="searchForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="ccol-xs-8 col-sm-8 col-md-3 col-lg-3">
...
<jsp:include page="employee_edit_dialog.jsp"></jsp:include>
<jsp:include page="employee_hallRoom_dialog.jsp"></jsp:include>
<script type="text/javascript" src="<%=basePath%>/views/hall/employeeController.js"></script>
</body>
</html>
