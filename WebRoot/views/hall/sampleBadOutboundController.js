...
function resetData() {
    var gridData = $("#badOutboundGrid").data("kendoGrid");
...
function inibadOutboundGrid() {
    $("#badOutboundGrid").kendoGrid({
        toolbar: ["excel"],
        excel: {
            allPages: true,
            fileName: "报损出库查询.xlsx",
            // proxyURL: basePath + "/hall/badOutbound/export.do",
            // filterable: true
        },
        ...
        dataSource: {
            ...
            transport: {
                read: {
                    url: basePath + "/hall/badOutbound/list.do",
                    type:"POST",
                    dataType: "json",
        ...
        columns: [
            ...
            {field:"unitName",title:"发货方名称",width:150,sortable:false,groupable:false,filterable:false},
            ...
            {field:"remark",title:"备注",width:300,sortable:false,groupable:false,filterable:false},
