            ...
            <div id="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                            ...
                            <div class="widget-main" id="searchPanel" style="display:none;">
                                <form class="form-horizontal" role="form" id="searchForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <select class="form-control chosen-select" id="filter_eq_ownerId" name="filter_eq_ownerId">
                        ...
                        <div id="supplyGrid" style="height:700px"></div>
...
<script type="text/javascript" src="<%=basePath%>/views/hall/supplyInboundController.js"></script>
</body>
</html>