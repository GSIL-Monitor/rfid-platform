                                ...
                                <form class="form-horizontal" id="searchForm">
                                    <div class="form-group">
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right"
                                               for="filter_LIKES_code">编号</label>
                                        <div class="ol-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="form-control" name="filter_LIKES_code" id="filter_LIKES_code" onkeyup="this.value=this.value.toUpperCase()"
                                                   placeholder="模糊查询">
                                        </div>
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right"
                                               for="filter_EQS_name">名称</label>
                                        <div class="ol-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="form-control" name="filter_LIKES_name" id="filter_EQS_name"
                                                   placeholder="模糊查询">
                                        </div>
                                        <%--<label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right"--%>
                                               <%--for="filter_EQI_status">状态</label>--%>
                                        <%--<div class="ol-xs-8 col-sm-8 col-md-3 col-lg-3">--%>
...
<jsp:include page="hallRoom_edit_dialog.jsp"></jsp:include>
<jsp:include page="../base/unit_dialog.jsp"></jsp:include>
<script type="text/javascript" src="<%=basePath%>/views/hall/hallRoomController.js"></script>
</body>
</html>
