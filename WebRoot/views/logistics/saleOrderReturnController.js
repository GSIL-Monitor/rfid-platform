        ...
        colModel: [
            {name: 'billNo', label: "单号", width: 40, sortable: true},
            {
                ...
                formatter: function (cellValue, options, rowObject) {
                    var html = "<a href='" + basePath + "/logistics/saleOrderReturn/copyAdd.do?billNo=" + rowObject.billNo + "'><i class='ace-icon fa fa-files-o' title='复制新增'></i></a>";
                    html += "<a style='text-decoration: none;margin-left: 20px' href='" + basePath + "/logistics/saleOrderReturn/edit.do?billNo=" + rowObject.billNo + "'><i class='ace-icon fa fa-edit'></i></a>";
...
function addSaleReturnBill() {
    location.href = basePath + "/logistics/saleOrderReturn/add.do";
}
