...
<jsp:include page="paymentGathering_edit.jsp"></jsp:include>
<script type="text/javascript" src="<%=basePath%>/views/logistics/paymentGatheringBillController.js"></script>
</body>
</html>