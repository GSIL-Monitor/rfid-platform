                        ...
                        <div class="widget-main padding-12">
                            <form id="editForm" class="form-horizontal" role="form" onkeydown="if(event.keyCode==13)return false;">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-2">
                                        <input class="form-control" value="${saleOrderReturn.billNo}" name="billNo"
                                    ...
                                    <div class="col-xs-2">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" id="search_actPrice" name="actPrice"
                                                   ...
                                                   value='${saleOrderReturn.actPrice}'/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-2">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" id="search_payPrice" name="payPrice"
                                                   ...
                                                   value='${saleOrderReturn.payPrice}'/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-2">
                                        <input class="form-control" id="search_discount" name="discount"
                                               value="${saleOrderReturn.discount}" onblur="search_discount_onblur()">
                                        </input>
                                    </div>
                                ...
                                <div>
                                    <input id="search_status" name="status" value="${saleOrderReturn.status}" type="hidden">
                                    </input>
                                    <input id="search_ownerId" name="ownerId" value="${saleOrderReturn.ownerId}"
                                           type="hidden">
                                    </input>
...
<script type="text/javascript" src="<%=basePath%>/views/logistics/saleOrderReturnDetailController.js"></script>
