                            ...
                            <div class="widget-toolbox padding-8 clearfix">
                                <div class="btn-toolbar" role="toolbar">
                                    ...
                                    <div class="btn-group btn-group-sm pull-left">
                                        ...
                                        <button type="button" class="btn btn-primary" onclick="setDet()">
                                            <i class="ace-icon fa fa-star"></i>
                                            <span class="bigger-110">设置推荐</span>
                                        </button>
                                        <%--<button type="button" class="btn btn-primary" onclick="preview()">--%>
                                            <%--<i class="ace-icon fa fa-list-ul"></i>--%>
                                            <%--<span class="bigger-110">预览</span>--%>
                                        <%--</button>--%>
                                    </div>
                            ...
                            <div class="widget-main" id="searchPanel" style="display:none">
                                <form class="form-horizontal" role="form" id="searchForm">
                                    <div class="form-group">
                                        ...
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right" for="search_name">款名</label>
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
...
<script type="text/javascript" src="<%=basePath%>/views/smart/newProductController.js"></script>
</body>
</html>