...
<body class="no-skin">
                            ...
                            <div class="widget-main" id="searchPanel" style="display:none">
                                <form class="form-horizontal" role="form" id="searchForm">
                                    <div class="form-group" align="center">
                                        ...
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right" for="search_id">编号</label>
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="form-control" id="search_id" name="filter_LIKES_id" type="text" onkeyup="this.value=this.value.toUpperCase()" placeholder="模糊查询"/>
                                        </div>
                                        ...
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right" for="search_designer">设计师</label>
                                         <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="form-control" id="search_designer" name="filter_LIKES_designer" type="text" placeholder="模糊查询"/>
                                        </div>
                                    </div>                 
   ...
   <script type="text/javascript" src="<%=basePath%>/views/smart/brandInfoController.js"></script>
</body>
</html>