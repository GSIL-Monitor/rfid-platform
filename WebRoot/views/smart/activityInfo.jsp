                            ...
                            <div class="widget-main" id="searchPanel" style="display:none">
                                <form class="form-horizontal" role="form" id="searchForm">
                                    <div class="form-group">
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 text-right control-label" for="search_styleId">编号</label>
...
<script type="text/javascript" src="<%=basePath%>/views/smart/activityInfoController.js"></script>
</body>
</html>