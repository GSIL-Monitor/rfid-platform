                            ...
                            <div class="widget-main" id="searchPanel" style="display:none">
                                <form class="form-horizontal" role="form" id="searchForm">
                                    <div class="form-group">
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right" for="search_code">code</label>
                                        ...
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right" for="search_recordDate">记录日期 </label>

                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <div class="input-group">
                                                <input class="form-control date-picker" id="search_recordDate"
                                                       type="text" name="filter_GTD_recordDate"
                                                ...
                                                <input class="form-control date-picker" type="text"
                                                       class="input-sm form-control" name="filter_LED_recordDate"
                                                       data-date-format="yyyy-mm-dd"/>
                                            </div>
...
<script type="text/javascript" src="<%=basePath%>/views/stock/guardingRecordController.js"></script>
<script type="text/javascript">
