    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer no-margin-top">
                <a href="#" class="btn" onclick="closeVendorDialog()">关闭</a>
                <a href="#" class="btn btn-primary" onclick="selectVendor();">确定</a>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div>
<script>
    ...
    function openSelectVendorDialog(vendorId, vendorName, dialogOpenPage) {
        $("#modal_vendor_search_table").data("vendorId", vendorId);
        $("#modal_vendor_search_table").data("vendorName", vendorName);
        $("#modal_vendor_search_table").on('show.bs.modal', function () {
    ...
    function assignVendorValue(rowId) {
        debugger;
        var row = $("#vendorSelect_Grid").jqGrid("getRowData", rowId);
        var vendorId = $("#modal_vendor_search_table").data("vendorId");
        var vendorName = $("#modal_vendor_search_table").data("vendorName");
        $(vendorId).val(row.id);
        $(vendorName).val(row.name);
    }

    function vendorGridReload() {
