...
<html>
    ...
    <body class="no-skin">
                                ...
                                <div class="widget-body">
                                    <div class="widget-toolbox padding-8 clearfix">
                                        <div class="btn-toolbar" role="toolbar">
                                            ...
                                            <div class="btn-group btn-group-sm pull-left">
                                                <button type="button" class="btn btn-primary" onclick="toConsole()">
                                                    <i class="ace-icon fa fa-plus"></i>
                                                    <span class="bigger-110">控制台</span>
                                                </button>
                                            </div>
                                        ...
                                        <form class="form-horizontal" role="form" id="searchForm">
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                                    <input class="form-control" id="search_code" name="LIKES_code"
                                                ...
                                                <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                                    <input class="form-control" id="search_name" name="LIKES_name"
                                                ...
                                                <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                                    <select class="chosen-select form-control" id="search_groupId"
                                                            name="EQS_groupId" data-placeholder="">
        ...
        <script type="text/javascript" src="<%=basePath%>/views/data/msgPushController.js"></script>
    </body>
</html>