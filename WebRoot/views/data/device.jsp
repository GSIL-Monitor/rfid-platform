                        ...
                        <div class="widget-body">
                            ...
                            <div class="widget-toolbox padding-8 clearfix">
                                <div class="btn-toolbar" role="toolbar">
                                    ...
                                    <div class="btn-group btn-group-sm pull-left">
                                        <button class="btn btn-primary" onclick="editConfig()">
                            ...
                            <div class="widget-main" id="searchPanel" style="display: none">
                                <form class="form-horizontal" role="form" id="searchForm">
                                    <div class="form-group">
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 text-right control-label" for="search_code">设备编号</label>

                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="form-control" id="search_code" name="filter_LIKES_code" type="text"
                                                   placeholder="模糊查询"/>
                                        </div>
                                        <%--<label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 text-right control-label" for="search_ownerId">所属方</label>

                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <!-- <input class="form-control" id="search_unitName" name="filter_LIKES_unitName" type="text" placeholder="模糊查询"/> -->
											<select class="chosen-select form-control" id="search_ownerId" name="filter_EQS_ownerId">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn">
																			<button class="btn btn-sm btn-default" id="setOwnerId"
                                                                                    type="button"
                                                                                    onclick="openUnitDialog('#search_ownerId','#form_ownerName',null,'withShop')">
...
<%--<jsp:include page="../base/warehouse_dialog.jsp"></jsp:include>--%>
<script type="text/javascript" src="<%=basePath%>/views/data/deviceController.js"></script>
<script type="text/javascript">
