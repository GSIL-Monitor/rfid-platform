                        ...
                        <div class="widget-body">
                            ...
                            <div class="widget-toolbox padding-8 clearfix">
                                <div class="btn-toolbar" role="toolbar">
                                    ...
                                    <div class="btn-group btn-group-sm pull-left">
                                        <button id="add_style_button" type="button" class="btn btn-primary" onclick="add()">
                            ...
                            <div class="widget-main" id="searchPanel" style="display:none">
                                <form class="form-horizontal" role="form" id="searchForm">
                                    <div class="form-group" >
                                        <label class="col-xs-4 col-sm-4 col-md-2 col-lg-2 text-right control-label" for="filter_LIKES_name">名称</label>

                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="form-control" id="filter_LIKES_name" name="filter_LIKES_name"
                                                   type="text"
                                                   placeholder="模糊查询"/>
                                        </div>
...
<script type="text/javascript" src="<%=basePath%>/views/location/regionalController.js"></script>
<jsp:include page="regional_edit.jsp"></jsp:include>
