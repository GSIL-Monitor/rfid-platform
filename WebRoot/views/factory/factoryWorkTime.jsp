                            ...
                            <div class="widget-main" id="searchPanel" style="display:none">
                                <form class="form-horizontal" role="form" id="searchForm">
                                    <div class="form-group">
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 text-right control-label" for="search_billNo">流程</label>
                                        ...
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right" for="search_code">工厂编号</label>
...
<script type="text/javascript" src="<%=basePath%>/views/factory/factoryWorkTimeController.js"></script>
<jsp:include page="factoryWorkTime_add.jsp"></jsp:include>
<jsp:include page="factoryWorkTime_edit.jsp"></jsp:include>
</body>
</html>