                                ...
                                <div class="btn-toolbar" role="toolbar">
                                    ...
                                    <div class="btn-group btn-group-sm pull-left">
                                        <button type="button" class="btn btn-primary" onclick="startUsing()">
                                            ...
                                            <span class="bigger-110">启用</span>
                                        </button>
                                        <button type="button" class="btn btn-primary" onclick="stopUsing()">
                                            <i class="ace-icon fa fa-remove"></i>
                                            <span class="bigger-110">废除</span>
                                        </button>
                                    </div>
                                    <div class="btn-group btn-group-sm pull-left">
                                        <button type="button" class="btn btn-primary" onclick="up()">
                                            <i class="ace-icon fa fa-arrow-up"></i>
                                            <span class="bigger-110">上移</span>
                                        </button>
                                        <button type="button" class="btn btn-primary" onclick="down()">
                                            <i class="ace-icon fa fa-arrow-down"></i>
                                            <span class="bigger-110">下移</span>
                                        </button>
                                    </div>
...
<jsp:include page="factoryToken_edit.jsp"></jsp:include>
<script type="text/javascript" src="<%=basePath%>/views/factory/factoryTokenController.js"></script>
</body>
</html>