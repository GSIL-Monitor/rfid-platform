                        ...
                        <div class="widget-body">
                            ...
                            <div class="widget-toolbox padding-8 clearfix">
                                <div class="btn-toolbar" role="toolbar">
                                    ...
                                    <div class="btn-group btn-group-sm pull-left" style='display:none'>
...
<jsp:include page="warehouse_edit.jsp"></jsp:include>
<jsp:include page="../base/unit_dialog.jsp"></jsp:include>
<script type="text/javascript" src="<%=basePath%>/views/sys/warehouseController.js"></script>
<script type="text/javascript">
