                        ...
                        <div class="col-xs-14 col-sm-7">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-sm btn-default" type="button" onclick="openUnitDialog('#form_ownerId','#form_unitName',callback,'head')">
                ...
                code:{
                    validators:{
                        ...
                        remote: {//ajax验证。server result:{"valid",true or false} 向服务发送当前input name值，获得一个json数据。例表示正确：{"valid",true}
                            url: basePath+"/sys/vendor/checkCode.do?pageType="+vendorStatus,//验证地址
                            message: '编号已存在',//提示消息
