...
<div id="edit-dialog2" style="text-align: center;font-size:12px; display: none" >
    ...
    <table  style="text-align:center" border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
        <thead >
        <tr >
            <th align="left"  nowrap="nowrap" style="border:0px;height: 20px;">商品</th>
            <th align="right" nowrap="nowrap" style="border:0px;height: 20px;">数量</th>
            <th align="right" nowrap="nowrap"style="border:0px;height: 20px;">原价</th>
            <th  align="right" nowrap="nowrap" style="border:0px;height: 20px;">折后价</th>
            <th align="right" nowrap="nowrap" style="border:0px;height: 20px;">金额</th>
        </tr>
        </thead>
        <tbody>
