                ...
                <form class="form-horizontal" role="form" id="editForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-14 col-sm-7">
                            <input class="form-control" id="form_code" name="code" onkeyup="this.value=this.value.toUpperCase()" type="text" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-14 col-sm-7">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-sm btn-default" type="button" onclick="openUnitDialog('#form_ownerId','#form_unitName',null,'head')">
