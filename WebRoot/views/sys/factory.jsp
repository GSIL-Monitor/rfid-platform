                            ...
                            <div class="widget-toolbox padding-8 clearfix">
                                <div class="btn-toolbar" role="toolbar">
                                    ...
                                    <div class="btn-group btn-group-sm pull-left">
                                        ...
                                        <button type="button" class="btn btn-primary" onclick="lock()">
                                            <i class="fa fa-check "></i>
                                            <span class="bigger-110">锁定</span>
                                        </button>
                                        <button type="button" class="btn btn-primary" onclick="unlock()">
                                            <i class="fa fa-times "></i>
                                            <span class="bigger-110">解锁</span>
                                        </button>
                                    </div>
...
<jsp:include page="factory_edit.jsp"></jsp:include>
<jsp:include page="../base/unit_dialog.jsp"></jsp:include>
<script type="text/javascript" src="<%=basePath%>/views/sys/factoryController.js"></script>
</body>
</html>