                                    ...
                                    <div class="form-group" id="styleid">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3" id="styleidname">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="search_origUnitId"
                                                       name="filter_eq_origunitid" type="hidden"/>
                                            </div>
                                        </div>
                                        <%--<div type="hidden">
...
<script type="text/javascript" src="<%=basePath%>/views/search/SaleorderFranchiseeController.js"></script>
<script>
    function onday() {
        var myDate=new Date();
