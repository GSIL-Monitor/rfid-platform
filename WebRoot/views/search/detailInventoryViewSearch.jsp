                ...
                <div class="row">
                    <div class="col-xs-12">
                       <div class="widget-body ">
                            ...
                            <div class="widget-toolbox padding-8 clearfix">
                                ...
                                <div class="widget-main" id="searchPanel" style="display:none;">
                                    <form class="form-horizontal" role="form" id="searchForm">
                                        ...
                                        <div class="form-group">
                                            <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right" for="filter_contains_deviceId">设备号</label>

                                            <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                                <input class="form-control" id="filter_contains_deviceId" name="filter_contains_deviceId" type="text"
                                                       placeholder="模糊查询"/>
                                            </div>
                           ...
                           <div id="inventoryGrid" style="height:500px"></div>
...
<script type="text/javascript" src="<%=basePath%>/views/search/detailInventoryViewSearchController.js"></script>
