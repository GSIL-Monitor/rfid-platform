                            ...
                            <div class="widget-toolbox padding-8 clearfix">
                                <div class="btn-toolbar" role="toolbar">
                                    ...
                                    <div class="btn-group btn-group-sm pull-left">
                                        ...
                                        <button id="edit_style_button" type="button" class="btn btn-primary" onclick="edit()">
                                    ...
                                    <div class="btn-group btn-group-sm pull-left">
                                        ...
                                        <button type="button" class="btn btn-info" onclick="uploadStyle()">

                                            <i class="ace-icon fa fa-file-excel-o" ></i>
                                            <span class="bigger-110">导入</span>
...
<script type="text/javascript" src="<%=basePath%>/views/prod/styleController.js"></script>
