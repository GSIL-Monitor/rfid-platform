                                ...
                                <div class="btn-toolbar" role="toolbar">
                                    <div class="btn-toolbar" role="toolbar">
                                        <div class="btn-group btn-group-sm pull-left">
                                            <button class="btn btn-success" onclick="downAll();">
                                                <i class="glyphicon glyphicon-download-alt"></i>
                                                <span class="bigger-110">下载全部</span>
                                            </button>
                                        </div>
                                    </div>
...
<script type="text/javascript" src="<%=basePath%>/views/syn/downBasicController.js"></script>
<div id="dialog"></div>
