                            ...
                            <div class="widget-main" id="searchPanel" style="display:none">
                                <form class="form-horizontal" role="form" id="searchForm">
                                    <div class="form-group">
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right" for="search_billNo">单号</label>
                                        ...
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right" for="search_srcBillNo">原始单号</label>

                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="form-control" id="search_srcBillNo" name="filter_LIKES_srcBillNo"style="width: 100%;"
                                                   onkeyup="this.value=this.value.toUpperCase()"
                                                   placeholder="模糊查询"/>
                                        </div>
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right" for="search_taskId">任务号</label>

                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="form-control" id="search_taskId" name="filter_LIKES_taskId"style="width: 100%;"
                                                   onkeyup="this.value=this.value.toUpperCase()"
                                                   placeholder="模糊查询"/>
                                        </div>
                                        ...
                                        <div class="form-group">
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right" for="search_createTime">单据日期 </label>
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            ...
                                            <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                                <input class="form-control" id="search_type" name="filter_EQI_type"style="width: 100%;"
                                                       placeholder="模糊查询"/>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="form-control" id="search_storageId" name="filter_LIKES_origId"style="width: 100%;"
                                                   onkeyup="this.value=this.value.toUpperCase()"
                                                   placeholder="模糊查询"/>
                                        </div>
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="form-control" id="search_unit2Id" name="filter_LIKES_destId"  style="width: 100%;"
                                                                              type="text" onkeyup="this.value=this.value.toUpperCase()"
                                                                              placeholder="模糊查询"/>
                                        </div>
                                        </div>
...
<script type="text/javascript" src="<%=basePath%>/views/syn/billManagerController.js"></script>
<div id="dialog"></div>
