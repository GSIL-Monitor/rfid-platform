...
(function ($) {
    ...
    $.fn.extend({
        cronGen: function () {
            ...
            var mainDiv = $("<div/>", { id: "CronGenMainDiv", style: "width:480px;height:300px;" });
            ...
            $(minutesTab).append("每&nbsp;");
            $("<input/>", { id: "MinutesInput", type: "number", min:"1",max:'59', value: "1", style: "width: 60px" }).appendTo(minutesTab);
            $(minutesTab).append("&nbsp;分钟(s)");
            ...
            $("<input/>", { id: "HoursInput", type: "number", min:"1",mix:"23",value: "1", style: "width: 40px" }).appendTo(hourlyOption1);
            $(hourlyOption1).append("&nbsp;小时(h)");
            ...
            $("<input/>", { id: "DaysInput", type: "number", mix:"31",min:'1', value: "1", style: "width: 40px" }).appendTo(dailyOption1);
            $(dailyOption1).append("&nbsp;天(d)");
            ...
            $(dailyOption2).append("&nbsp;每天执行&nbsp");
            $(dailyOption2).appendTo(dailyTab);

            $(dailyTab).append("开始执行时间&nbsp;");
            ...
            $("<input/>", { id: "MonthInput", type: "number", min:"1",mix:"12", value: "1", style: "width: 60px" }).appendTo(monthlyOption1);
            $(monthlyOption1).append("&nbsp;月&nbsp第");
            $("<input/>", { id: "DayOfMOnthInput", type: "number", min:"1",mix:"31", value: "1", style: "width: 60px" }).appendTo(monthlyOption1);
            $(monthlyOption1).append("&nbsp;天(s)");
            ...
            $("<input/>", { id: "EveryMonthInput", type: "number",mix:"12",mix:"1", value: "1", style: "width: 60px" }).appendTo(monthlyOption2);
            $(monthlyOption2).append("&nbsp;月(s)");
            $(monthlyOption2).append("&nbsp;第&nbsp;");
            $(monthlyOption2).append('<select id="WeekDay" class="day-order-in-month" style="width: 80px"></select>');
            $(monthlyOption2).append("&nbsp;周&nbsp;");
            ...
            $(yearlyOption1).append("&nbsp;在第&nbsp;");
            $("<input/>", { id: "YearInput", type: "number",max:"31",min:"1", value: "1", style: "width: 40px" }).appendTo(yearlyOption1);
            ...
            // Add an input
            var $i = $("<input>", { type: 'text', placeholder: 'Cron 表达式', name:that.attr("name"), disabled:true,readonly: 'readonly'}).addClass("form-control").val($(that).val());
            $i.appendTo($g);
            // Add the button
            var $b = $("<button class=\"btn btn-default \" type=\"button\">修改</button>");
