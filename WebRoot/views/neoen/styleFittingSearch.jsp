                                    ...
                                    <form class="form-horizontal" role="form" id="searchForm">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                                <select id="filter_in_warehId"name="filter_in_storeId" multiple="multiple" data-placeholder="编号列表">
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                                <div class="input-group">
                                                    <input id="filter_gte_fittingDate" class="form-control date-picker"
                                                           name="filter_gte_fittingDate"
                                                           readonly
                                                           data-date-format="yyyy-mm-dd"/>
                                                <span class="input-group-addon">
															<i class="fa fa-exchange"></i>
                                                      </span>
                                                    <input id="filter_lte_fittingDate" class="form-control date-picker"
                                                           name="filter_lte_fittingDate"
                                                           readonly
                                                           data-date-format="yyyy-mm-dd"/>
                                                </div>
                                            </div>
...
<script type="text/javascript" src="<%=basePath%>/views/neoen/styleFittingSearchController.js"></script>
