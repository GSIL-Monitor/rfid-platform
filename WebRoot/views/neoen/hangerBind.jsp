                            ...
                            <div class="widget-main" id="searchPanel" style="display:none;">
                                <form class="form-horizontal" role="form" id="searchForm">
                                    <div class="form-group">
                                        ...
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right"
                                               for="filter_LIKES_code">EPC</label>

                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="form-control" id="filter_LIKES_code"
                                                   name="filter_LIKES_code" type="text"
                                                   placeholder="模糊查询"/>
                                        </div>
                                        <label class="col-xs-4 col-sm-4 col-md-1 col-lg-1 control-label text-right"
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-3 col-lg-3">
                                            <input class="form-control" id="filter_LIKES_sku"
                                                   name="filter_LIKES_sku" type="text"
                                                   placeholder="模糊查询"/>
                                        </div>
                                    </div>
...
<script type="text/javascript" src="<%=basePath%>/views/neoen/hangerBindController.js"></script>
</body>
</html>