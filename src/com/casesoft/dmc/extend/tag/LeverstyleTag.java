...
public class LeverstyleTag extends AbstractBaseTag {

	public LeverstyleTag() {
		super();
	}

	public LeverstyleTag(String styleId, String colorId, String sizeId) {
		super();
	...
	public String getUniqueCode(int startNo, int i) {
		...
		this.uniqueCode = p.getId()
				+ CommonUtil.produceIntToString(startNo + i - 1,
						this.getSerialLength()) + Constant.TagSerial.Leverstyle;
		return uniqueCode;
	}
