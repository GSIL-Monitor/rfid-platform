...
public class SHUNZATag extends AbstractBaseTag {

	public SHUNZATag() {
		super();
	}

	public SHUNZATag(String styleId, String colorId, String sizeId) {
		super();
	...
	public String getUniqueCode(int startNo, int i) {
		...
		this.uniqueCode = p.getId()
				+ CommonUtil.produceIntToString(startNo + i - 1,
						this.getSerialLength()) + Constant.TagSerial.SHUNZA;
		return uniqueCode;
	}
