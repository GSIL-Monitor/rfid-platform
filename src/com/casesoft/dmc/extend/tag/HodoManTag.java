...
public class HodoManTag extends AbstractBaseTag {
	 ...
	 public HodoManTag(String styleId, String colorId, String sizeId) {
	        super();
	...
	public String getClientUpdateFilePath() throws Exception {
		// TODO Auto-generated method stub
		return PropertyUtil.getValue("HodoMan_updateFile_Path");
	}
