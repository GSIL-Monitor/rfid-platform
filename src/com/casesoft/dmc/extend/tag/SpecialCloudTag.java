...
public class SpecialCloudTag extends AbstractBaseTag {
    
	
	 public SpecialCloudTag() {
	        super();
	 }

	 
	 public SpecialCloudTag(String styleId, String colorId, String sizeId) {
	        super();
	...
	public String getUniqueCode(int startNo, int i) {
		 ...
		 this.uniqueCode = p.getId() + CommonUtil.produceIntToString(startNo + i - 1, this.getSerialLength())
				           + Constant.TagSerial.SpecialCloud;
		 return uniqueCode;
	}
