...
/**
 * Created by WinLi on 2017-05-08.
 */
public class IvyTag extends AbstractBaseTag {
    public IvyTag() {
        super();
    }

    public IvyTag(String styleId, String colorId, String sizeId) {
        super();
    ...
    public String getUniqueCode(int startNo, int i) {
        ...
        this.uniqueCode = p.getId()
                ...
                this.getSerialLength()) + Constant.TagSerial.Ivykki;
        return uniqueCode;
    }
