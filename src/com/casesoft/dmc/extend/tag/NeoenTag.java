...
/**
 * Created by Alvin-PC on 2017/4/26 0026.
 */
public class NeoenTag  extends AbstractBaseTag{
    public NeoenTag() {
        super();
    }


    public NeoenTag(String styleId, String colorId, String sizeId) {
        super();
