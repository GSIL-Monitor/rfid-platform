...
/**
 * Created by WinLi on 2017-06-01.
 */
public class HeyiTag extends AbstractBaseTag {
    public HeyiTag() {
        super();
    }


    public HeyiTag(String styleId, String colorId, String sizeId) {
        super();
