...
public class XinShuangTag extends AbstractBaseTag {
	 ...
	 public XinShuangTag(String styleId, String colorId, String sizeId) {
	        super();
...
//		String epcStr = p.getId() + SerialNo;
		this.epc = this.uniqueCode+CommonUtil.produceIntToString(0, 24 - uniqueCode.length());
	    return this.epc;
	}
