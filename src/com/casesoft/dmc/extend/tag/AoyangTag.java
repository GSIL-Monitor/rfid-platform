...
public class AoyangTag extends AbstractBaseTag {
	 ...
	 public AoyangTag(String styleId, String colorId, String sizeId) {
	        super();
	...
	public String getClientUpdateFilePath() throws Exception {
		// TODO Auto-generated method stub
		return PropertyUtil.getValue("aoyang_updateFile_Path");
	}
