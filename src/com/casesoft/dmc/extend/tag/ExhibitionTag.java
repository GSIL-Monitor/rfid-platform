...
public class ExhibitionTag extends AbstractBaseTag {

	public ExhibitionTag() {
		super();
	}

	public ExhibitionTag(String styleId, String colorId, String sizeId) {
		super();
...
//		 String SerialNo =
//		 this.uniqueCode.substring(this.uniqueCode.length()-7,this.uniqueCode.length()-2);
	...
	public String getUniqueCode(int startNo, int i) {
		...
		this.uniqueCode = p.getId()
				+ CommonUtil.produceIntToString(startNo + i - 1,
						this.getSerialLength()) + Constant.TagSerial.Exhibition;
		return uniqueCode;
	}
