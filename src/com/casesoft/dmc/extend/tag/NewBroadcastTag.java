...
public class NewBroadcastTag extends AbstractBaseTag {

	public NewBroadcastTag() {
		super();
	}

	public NewBroadcastTag(String styleId, String colorId, String sizeId) {
		super();
	...
	public String getUniqueCode(int startNo, int i) {
		...
		this.uniqueCode = p.getId()
				+ CommonUtil.produceIntToString(startNo + i - 1,
						this.getSerialLength()) + Constant.TagSerial.NewBroadcast;
		return uniqueCode;
	}
