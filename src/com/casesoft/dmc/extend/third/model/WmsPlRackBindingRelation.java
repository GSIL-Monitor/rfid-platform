 ...
 */
@Entity
@Table(name = "Third_wms_Pl_RackBinding")
public class WmsPlRackBindingRelation implements Serializable {
    ...
    public WmsPlRackBindingRelation() {
    }
    public WmsPlRackBindingRelation(String styleId, String colorId, String rackBarcode) {
        this.styleId = styleId;
        this.colorId = colorId;
        this.rackBarcode = rackBarcode;
    }

  public WmsPlRackBindingRelation(String styleId, String colorId,
                                    String rackBarcode, String rackName,
                                    String floorBarcode, String floorName,
    ...
    public WmsPlRackBindingRelation(String styleId, String colorId,
                                    ...
                                    String floorId,String floorBarcode, String floorName, String floorImage, String floorRemark,
